...
const Chatbot: React.FC = () => {
  ...
  useEffect(() => {
    if (transcript && isRecording) { // Chỉ cập nhật nếu vẫn đang ghi
  ...
  return (
    <div className="flex flex-col flex-1 bg-white rounded-lg shadow-md">
      ...
      {/* Vùng nhập liệu */}
      <form onSubmit={handleInputSubmit} className="border-t border-gray-200 text-black p-4 flex items-center bg-white rounded-b-lg">
        <button
          type="button"
